...
public class MainActivity extends AppCompatActivity implements SensorEventListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        Intent intent = null;
        if (v.getId() == R.id.bt_chart){
            intent = new Intent(this, Chart2Activity.class); //Ili Chart Activity s tekstualnim prikazom
        } else if (v.getId() == R.id.bt_text){
            intent = new Intent(this, ChartActivity.class); //Ili Chart Activity s tekstualnim prikazom
        }
        intent.putStringArrayListExtra("temperatures", temperatures);
        intent.putStringArrayListExtra("humidities", humidities);
